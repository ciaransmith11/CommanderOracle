...
export async function* buildChat(
  ...
  const context = [
    ...
    'Do NOT end with a separate totals, tally, deck-composition, or role-coverage section — the app displays the verified 100-card count beneath your response, and each section heading already carries its own count. Repeating those numbers is redundant; just give the role sections and the decklist block.',
